...
def main(config_name: str) -> None:
    ...
    print("-----------------------------------")
    print("evaluation:")
    print(f"val_acc: {val_acc} val_loss: {val_loss} val_precision: {val_precision} val_recall: {val_recall} val_f1_score: {val_f1_score}")
    print("----")
    print("history:")
    print(f"val_acc: {history.history['val_accuracy']} val_loss: {history.history['val_loss']} val_precision: {history.history['val_precision']} val_recall: {history.history['val_recall']} val_f1_score: {history.history['val_f1_score']}")
