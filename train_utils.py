...
def build_and_train(run, train_ds, validation_ds):
    ...
    model_builder_object = Model_builder(input_shape=(256, 256, 1) ,num_classes=2, encoder_filters=run.config.encoder_filters, encoder_kernel_size=run.config.encoder_kernel_size, encoder_l1 =run.config.encoder_l1,
